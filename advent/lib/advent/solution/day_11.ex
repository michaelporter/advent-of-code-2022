defmodule Advent.Solution.Day11 do
  ...
  defp parse_response_body_part_two do
    [
      %{
        items: Enum.map([98, 70, 75, 80, 84, 89, 55, 98], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 * 2),
        test: &(rem(&1, 11) == 0),
        true_destination: 1,
        false_destination: 4,
      ...
      %{
        items: Enum.map([59], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 * &1),
        test: &(rem(&1, 19) == 0),
        true_destination: 7,
        false_destination: 3,
      ...
      %{
        items: Enum.map([77, 95, 54, 65, 89], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 + 6),
        test: &(rem(&1, 7) == 0),
        true_destination: 0,
        false_destination: 5,
      ...
      %{
        items: Enum.map([71, 64, 75], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 + 2),
        test: &(rem(&1, 17) == 0),
        true_destination: 6,
        false_destination: 2,
      ...
      %{
        items: Enum.map([74, 55, 87, 98], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 * 11),
        test: &(rem(&1, 3) == 0),
        true_destination: 1,
        false_destination: 7,
      ...
      %{
        items: Enum.map([90, 98, 85, 52, 91, 60], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 + 7),
        test: &(rem(&1, 5) == 0),
        true_destination: 0,
        false_destination: 4,
      ...
      %{
        items: Enum.map([99, 51], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 + 1),
        test: &(rem(&1, 13) == 0),
        true_destination: 5,
        false_destination: 2,
      ...
      %{
        items: Enum.map([98, 94, 59, 76, 51, 65, 75], fn x -> (x / 1) |> Float.to_string end),
        operation: &(&1 + 5),
        test: &(rem(&1, 2) == 0),
        true_destination: 3,
        false_destination: 6,
